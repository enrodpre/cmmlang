...
constexpr token_t::properties::properties(pattern_t t, cstring p, type_category_t ty) noexcept
    : pattern_type(t),
      pattern(p),
      type(ty) {}
...
constexpr const token_t::properties_map& token_t::properties_array() {
  ...
  static const token_t::properties_map MAP{
      ...
      {int_t,        {MULTI_CHAR, "int", type_category_t::sint_t}                                   },
      {float_t,      {MULTI_CHAR, "float", type_category_t::float_t}                                },
      {char_t,       {MULTI_CHAR, "char", type_category_t::char_t}                                  },
      {if_,          {MULTI_CHAR, "if"}                                                             },
      ...
      {inc,          {MULTI_CHAR, "++"}                                                             },
      {dec,          {MULTI_CHAR, "--"}                                                             },
      {bool_lit,     {REGEX, "(true|false)", type_category_t::bool_t}                               },
      {int_lit,      {REGEX, "([-+]?[0-9]+(?=[^.]))", type_category_t::sint_t}                      },
      {char_lit,     {REGEX, "('.')", type_category_t::char_t}                                      },
      {str_lit,      {REGEX, "(\".*\")", type_category_t::char_t}                                   },
      {float_lit,    {REGEX, "([+-]?([0-9]+[.][0-9]*)|([0-9]*[.][0-9]+))", type_category_t::float_t}},
      {label,        {REGEX, "([A-Za-z_]+[A-Za-z_0-9]*):"}                                          },
